    ...
    <div className="w-full max-w-5xl px-4 xl:px-0 py-10 lg:pt-16 mx-auto">
      <div className="inline-flex items-center">
       ...
       <path fill="#13d88c" d="M0 192c0-35.3 28.7-64 64-64c.5 0 1.1 0 1.6 0C73 91.5 105.3 64 144 64c15 0 29 4.1 40.9 11.2C198.2 49.6 225.1 32 256 32s57.8 17.6 71.1 43.2C339 68.1 353 64 368 64c38.7 0 71 27.5 78.4 64c.5 0 1.1 0 1.6 0c35.3 0 64 28.7 64 64c0 11.7-3.1 22.6-8.6 32L8.6 224C3.1 214.6 0 203.7 0 192zm0 91.4C0 268.3 12.3 256 27.4 256l457.1 0c15.1 0 27.4 12.3 27.4 27.4c0 70.5-44.4 130.7-106.7 154.1L403.5 452c-2 16-15.6 28-31.8 28l-231.5 0c-16.1 0-29.8-12-31.8-28l-1.8-14.4C44.4 414.1 0 353.9 0 283.4z"/></svg>
        {/* <svg id="ICON" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><defs><style>.cls-1{fill:#c6c8ca}.cls-2{fill:#e4b790}.cls-3{fill:#cba383}.cls-4{fill:#2a3342}.cls-5{fill:#a8a9aa}.cls-10{fill:#b2b2b2}</style></defs><rect className="cls-1" x="268.45" y="377.31" width="149.67" height="54.17" rx="24.81" transform="rotate(115.07 343.28 404.39)"/><path className="cls-2" d="M419.66 335.07v6.67a16.87 16.87 0 0 1-16.89 16.88h-42.59a16.9 16.9 0 0 1-16.91-16.88v-6.67a16.9 16.9 0 0 1 16.91-16.88h42.59a16.87 16.87 0 0 1 16.89 16.88z"/><path className="cls-3" d="M419.66 335.07v3.33h-76.39v-3.33a16.9 16.9 0 0 1 16.91-16.88h42.59a16.87 16.87 0 0 1 16.89 16.88zM137.78 262.2h50.15v73.19h-50.15z"/><ellipse className="cls-3" cx="268.11" cy="214.49" rx="15.45" ry="16.54"/><ellipse className="cls-3" cx="63.16" cy="214.49" rx="15.45" ry="16.54"/><circle className="cls-2" cx="165.64" cy="209.88" r="99.48"/><circle className="cls-4" cx="205.43" cy="211.92" r="11.94"/><circle className="cls-4" cx="125.85" cy="211.92" r="11.94"/><ellipse className="cls-4" cx="85.72" cy="180.53" rx="25.72" ry="20.32" transform="rotate(-68.43 85.723 180.53)"/><ellipse className="cls-4" cx="248.89" cy="180.53" rx="20.32" ry="25.72" transform="rotate(-18.92 248.818 180.489)"/><path className="cls-4" d="M232.63 168c0 6.92-28.62 28-63.91 28s-63.9-21.08-63.9-28 28.61-12.53 63.9-12.53 63.91 5.61 63.91 12.53z"/><rect className="cls-5" x="371.91" y="205.85" width="19.45" height="19.6" rx="9.72"/><path className="cls-4" d="M482.47 303.37a15.19 15.19 0 0 1-15.17 15.17H296a15.19 15.19 0 0 1-15.18-15.17z"/><path d="M482.47 303.37a15.19 15.19 0 0 1-15.17 15.17h-8.85l7.55-15.17z" style={{fill:"#3f4d5f"}}/><path d="M319.74 318.54H296a15.19 15.19 0 0 1-15.18-15.17H309z" style={{fill:"#1d222a"}}/><path d="M466.35 303.21H296.92a77.72 77.72 0 0 1 77.76-77.76h13.91a77.74 77.74 0 0 1 77.76 77.76z" style={{fill:"#bbbec0"}}/><path d="M466.35 303.21h-52.88c-3.31-39.7-20.81-66.08-30.39-77.76h5.51a77.74 77.74 0 0 1 77.76 77.76z" style={{fill:"#cbcccd"}}/><path className="cls-5" d="M331.28 238.67a220.79 220.79 0 0 0-13 64.54h-21.36a77.71 77.71 0 0 1 34.36-64.54z"/><path className="cls-1" d="M70.18 110.41h194.93v56.09H70.18z"/><rect className="cls-1" x="29.53" y="26.32" width="272.22" height="86.12" rx="43.06"/><rect className="cls-10" x="88.03" y="103.77" width="14.22" height="40.29" rx="7.11"/><rect className="cls-10" x="123.28" y="103.77" width="14.22" height="40.29" rx="7.11"/><rect className="cls-10" x="158.53" y="103.77" width="14.22" height="40.29" rx="7.11"/><rect className="cls-10" x="193.77" y="103.77" width="14.22" height="40.29" rx="7.11"/><rect className="cls-10" x="229.02" y="103.77" width="14.22" height="40.29" rx="7.11"/><path className="cls-1" d="M124.12 335.39h77.48a60.74 60.74 0 0 1 60.74 60.74v87.63h-199v-87.64a60.74 60.74 0 0 1 60.78-60.73z"/><path className="cls-1" d="M125.85 318.18h75.29v27.48h-75.29z"/><rect className="cls-1" x="213.32" y="382.61" width="149.67" height="54.17" rx="24.81" transform="rotate(47.61 288.148 409.66)"/><rect className="cls-1" x="-5.58" y="385.8" width="145.49" height="54.17" rx="24.46" transform="rotate(91.2 67.158 412.896)"/><path className="cls-4" d="M125.85 318.18h8.17v165.57h-8.17z"/><circle className="cls-4" cx="154.04" cy="364.98" r="8.48"/><circle className="cls-4" cx="154.04" cy="413.69" r="8.48"/><circle className="cls-4" cx="154.04" cy="458.21" r="8.48"/></svg> */}
        {/* End Logo */}

        <div className="border-s border-neutral-700 ps-5 ms-5">
          <p className="text-sm text-neutral-400">
            © 2025 SwadRich Tiffin Service.
          </p>
        </div>
      </div>
    </div>
